const message = {
  zhHans: {
    ...
    apiSettings: {
      enableApi: '启用API服务器',
      port: '端口',
      portValidationError: '端口必须在1024-65535之间',
      running: '运行中',
      starting: '启动中',
      stopped: '已停止',
      authentication: '身份验证',
      ...
      apiKeyGenerated: 'API密钥已生成',
      cors: '跨域资源共享',
      allowedOrigins: '允许的源',
      allowedOriginsHelp: '允许访问API的域名，用逗号分隔，*表示允许所有域名',
      allowedOriginsPlaceholder: '请输入允许的源',
      autoDeploy: '自动部署',
      autoDeployHelp: '发布文章时自动部署到静态站点',
      serverStatus: '服务器状态',
      serverRunning: 'API服务器正在运行',
      serverStopped: 'API服务器已停止',
      apiUrl: 'API地址',
      copyUrl: '复制地址',
      urlCopied: '地址已复制到剪贴板',
      copyFailed: '复制失败',
      ...
      saveError: '保存失败',
      logViewer: '实时日志查看',
      startLogWatching: '开始监控',
      stopLogWatching: '停止监控',
      clearLogs: '清空日志',
      copyLogs: '复制日志',
      exportLogs: '导出日志',
      logLevel: '日志级别',
      ...
      errorLogs: '错误',
      debugLogs: '调试',
      logWatchingActive: '正在监控API服务器日志...',
      logWatchingStopped: '日志监控已停止',
      logsCleared: '日志已清空',
      logsCopied: '日志已复制到剪贴板',
      logsCopyFailed: '复制日志失败',
      logsExported: '日志已导出',
      logsExportFailed: '导出日志失败',
  ...
  zh_TW: {
    ...
    apiSettings: {
      enableApi: '啟用API服務器',
      port: '端口',
      portValidationError: '端口必須在1024-65535之間',
      running: '運行中',
      starting: '啟動中',
      stopped: '已停止',
      authentication: '身份驗證',
      regenerateKey: '重新生成密鑰',
      apiKey: 'API密鑰',
      apiKeyPlaceholder: '請輸入API密鑰',
      apiKeyGenerated: 'API密鑰已生成',
      cors: '跨域資源共享',
      allowedOrigins: '允許的源',
      allowedOriginsHelp: '允許訪問API的域名，用逗號分隔，*表示允許所有域名',
      allowedOriginsPlaceholder: '請輸入允許的源',
      autoDeploy: '自動部署',
      autoDeployHelp: '發布文章時自動部署到靜態站點',
      serverStatus: '服務器狀態',
      serverRunning: 'API服務器正在運行',
      serverStopped: 'API服務器已停止',
      apiUrl: 'API地址',
      copyUrl: '複製地址',
      urlCopied: '地址已複製到剪貼板',
      copyFailed: '複製失敗',
      ...
      stopError: '停止錯誤',
      stopFailed: '停止失敗',
      serverStarted: '服務器已啟動',
      settingsSaved: '設置已保存',
      saveError: '保存失敗',
      logViewer: '即時日誌查看',
      startLogWatching: '開始監控',
      stopLogWatching: '停止監控',
      clearLogs: '清空日誌',
      copyLogs: '複製日誌',
      exportLogs: '匯出日誌',
      logLevel: '日誌級別',
      ...
      errorLogs: '錯誤',
      debugLogs: '除錯',
      logWatchingActive: '正在監控API服務器日誌...',
      logWatchingStopped: '日誌監控已停止',
      logsCleared: '日誌已清空',
      logsCopied: '日誌已複製到剪貼簿',
      logsCopyFailed: '複製日誌失敗',
      logsExported: '日誌已匯出',
      logsExportFailed: '匯出日誌失敗',
  ...
  en: {
    ...
    apiSettings: {
      ...
      allowedOriginsHelp: 'Domains allowed to access the API, separated by commas, * means allow all domains',
      allowedOriginsPlaceholder: 'Enter allowed origins',
      autoDeploy: 'Auto Deploy',
      autoDeployHelp: 'Automatically deploy to static site when publishing articles',
      serverStatus: 'Server Status',
      serverRunning: 'API server is running',
      serverStopped: 'API server is stopped',
      apiUrl: 'API URL',
      copyUrl: 'Copy URL',
      ...
      startLogWatching: 'Start Watching',
      stopLogWatching: 'Stop Watching',
      ...
      errorLogs: 'Error',
      debugLogs: 'Debug',
      logWatchingActive: 'Watching API server logs...',
      logWatchingStopped: 'Log watching stopped',
  ...
  fr_FR: {
    ...
    apiSettings: {
      enableApi: 'Activer le serveur API',
      port: 'Port',
      portValidationError: 'Le port doit être entre 1024-65535',
      running: 'En cours',
      starting: 'Démarrage',
      stopped: 'Arrêté',
      ...
      allowedOriginsHelp: 'Domaines autorisés à accéder à l\'API, séparés par des virgules, * signifie autoriser tous les domaines',
      allowedOriginsPlaceholder: 'Entrez les origines autorisées',
      autoDeploy: 'Déploiement automatique',
      autoDeployHelp: 'Déployer automatiquement vers le site statique lors de la publication des articles',
      serverStatus: 'Statut du serveur',
      serverRunning: 'Le serveur API est en cours d\'exécution',
      serverStopped: 'Le serveur API est arrêté',
      apiUrl: 'URL API',
      ...
      startError: 'Erreur de démarrage',
      stopError: 'Erreur d\'arrêt',
      stopFailed: 'Échec de l\'arrêt',
      serverStarted: 'Serveur démarré',
      settingsSaved: 'Paramètres sauvegardés',
      saveError: 'Échec de la sauvegarde',
      logViewer: 'Visualisateur de journaux en temps réel',
      startLogWatching: 'Commencer la surveillance',
      stopLogWatching: 'Arrêter la surveillance',
      ...
      infoLogs: 'Info',
      warningLogs: 'Avertissement',
      errorLogs: 'Erreur',
      debugLogs: 'Débogage',
      logWatchingActive: 'Surveillance des journaux du serveur API...',
      logWatchingStopped: 'Surveillance des journaux arrêtée',
      ...
      logsExportFailed: 'Échec de l\'exportation des journaux',
      noLogsAvailable: 'Aucun journal disponible',
      logStatus: 'Statut des journaux',
      totalLogs: 'Total des journaux',
      showTimestamps: 'Afficher les horodatages',
      autoScroll: 'Défilement automatique',
      followLogs: 'Suivre les derniers journaux',
    },
  ...
  ru: {
    ...
    apiSettings: {
      enableApi: 'Включить API сервер',
      port: 'Порт',
      portValidationError: 'Порт должен быть между 1024-65535',
      running: 'Запущен',
      ...
      allowedOriginsHelp: 'Разрешенные домены для доступа к API, разделенные запятыми. * означает разрешить все домены',
      allowedOriginsPlaceholder: 'Введите разрешенные источники',
      autoDeploy: 'Автоматическая публикация',
      autoDeployHelp: 'Автоматически публиковать при публикации статьи',
      serverStatus: 'Статус сервера',
      serverRunning: 'API сервер запущен',
      serverStopped: 'API сервер остановлен',
      apiUrl: 'Адрес API',
      copyUrl: 'Скопировать адрес',
      urlCopied: 'Адрес скопирован в буфер обмена',
      ...
      startLogWatching: 'Начать отслеживание',
      stopLogWatching: 'Остановить отслеживание',
      ...
      allLogs: 'Все логи',
      infoLogs: 'Информация',
      warningLogs: 'Предупреждения',
      errorLogs: 'Ошибки',
      debugLogs: 'Отладка',
      logWatchingActive: 'Отслеживание логов API сервера...',
      logWatchingStopped: 'Отслеживание логов остановлено',
      logsCleared: 'Логи очищены',
      logsCopied: 'Логи скопированы в буфер обмена',
      logsCopyFailed: 'Ошибка копирования логов',
      logsExported: 'Логи экспортированы',
      logsExportFailed: 'Ошибка экспорта логов',
      noLogsAvailable: 'Нет доступных логов',
      logStatus: 'Статус логов',
      totalLogs: 'Всего логов',
      showTimestamps: 'Показывать временные метки',
      autoScroll: 'Автопрокрутка',
      followLogs: 'Следовать за новыми логами',
    },
  ...
  ja_JP: {
    ...
    apiSettings: {
      ...
      port: 'ポート',
      portValidationError: 'ポートは1024-65535の間である必要があります',
      running: '実行中',
      starting: '起動中',
      stopped: '停止済み',
      authentication: '認証',
      ...
      allowedOriginsHelp: 'APIアクセスを許可するドメイン、カンマ区切り、*はすべて許可',
      allowedOriginsPlaceholder: '許可するオリジンを入力してください',
      autoDeploy: '自動デプロイ',
      autoDeployHelp: '記事公開時に自動的にデプロイします',
      serverStatus: 'サーバーステータス',
      serverRunning: 'APIサーバーが実行中',
      serverStopped: 'APIサーバーが停止',
      apiUrl: 'APIアドレス',
      copyUrl: 'アドレスをコピー',
      urlCopied: 'アドレスがクリップボードにコピーされました',
      ...
      serverStarted: 'サーバーが開始されました',
      settingsSaved: '設定が保存されました',
      saveError: '保存に失敗しました',
      logViewer: 'リアルタイムログビューア',
      startLogWatching: '監視開始',
      stopLogWatching: '監視停止',
      clearLogs: 'ログをクリア',
      copyLogs: 'ログをコピー',
      ...
      errorLogs: 'エラー',
      debugLogs: 'デバッグ',
      logWatchingActive: 'APIサーバーログを監視中...',
      logWatchingStopped: 'ログ監視が停止されました',
      logsCleared: 'ログがクリアされました',
      logsCopied: 'ログがクリップボードにコピーされました',
      logsCopyFailed: 'ログのコピーに失敗しました',
      logsExported: 'ログがエクスポートされました',
      logsExportFailed: 'ログのエクスポートに失敗しました',
